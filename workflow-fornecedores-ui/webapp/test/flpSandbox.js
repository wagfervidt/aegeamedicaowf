		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#combraegeawfaprovacaoworkflowfornecedoresui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combraegeawfaprovacaoworkflowfornecedoresui-display": {
								"semanticObject": "combraegeawfaprovacaoworkflowfornecedoresui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.br.aegea.wfaprovacao.workflowfornecedoresui",
									"url": sap.ui.require.toUrl("com/br/aegea/wfaprovacao/workflowfornecedoresui")
								}
							}
						}
					}

sap.ui.define(
  [
    ...
    "sap/ui/Device",
    "com/br/aegea/wfaprovacao/workflowadminui/workflowadministradorui/model/models",
  ],
  function (UIComponent, Device, models) {
    "use strict";

    return UIComponent.extend(
      "com.br.aegea.wfaprovacao.workflowadminui.workflowadministradorui.Component",
      {
        metadata: {
          manifest: "json",
        },
